...
Thank you for your interest in `loopback-oracle-builder`, an open source project
administered by StrongLoop.

Contributing to `loopback-oracle-builder` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-oracle-builder)
